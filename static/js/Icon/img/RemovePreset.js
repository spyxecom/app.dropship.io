...
export const RemovePreset = ({width, height, className, color, outline}) =>
  outline ? (
    <svg
      width={width}
      height={height}
      className={cls(className, 'icon icon-remove-preset icon-remove-preset-outline')}
      viewBox="0 0 24 24"
    ...
    <svg
      width={width}
      height={height}
      className={cls(className, 'icon icon-remove-preset icon-remove-preset-bold')}
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
      fill={color ? color : '#D71313'}
    >
